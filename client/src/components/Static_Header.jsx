...
const Header = () => {
  ...
  submenu: [
    ...
    { label: "MPPT Solar Charge Controller", href: "/products/11" },
    { label: "DC Surge Protection Device", href: "/products/12" },
    { label: "Rooftop Solar Mounting Structure", href: "/products/13" },
    { label: "3kW Grid-Tie Inverter", href: "/products/14" },
  ],
        ...
        <div className="header-top">
          <div className="top-inner display-flex">
            <ul className="info flex justify-between items-center">
              <li><i className="bi bi-clock-fill"></i> Mon-Fri, 10:00-7:00</li>
              <li><i className="bi bi-geo-alt-fill"></i> B -71, Ground Floor, Transport Nagar, Sector 69, Noida 201301</li>
              <li><i className="bi bi-envelope-fill"></i> <a href="mailto:sales@spautomation.org">sales@spautomation.org</a></li>
              <li><i className="bi bi-telephone-outbound-fill"></i> <a href="tel:+919910089643">+91 99100 89643</a></li>
            </ul>
          </div>
        </div>
...
>
  <i class="bi bi-file-arrow-down mr-3"></i>
  Catalogues
</a>
